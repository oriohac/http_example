...
class _OtherMethodsState extends State<OtherMethods> {
  ...
  Future<void> postData() async{
    var response = await http.post(Uri.parse('https://jsonplaceholder.typicode.com/posts/2'),
  ...
  Future<void> putData() async{
    var response = await http.put(Uri.parse('https://jsonplaceholder.typicode.com/posts/2'),
    headers: {"content-type":"application/json"},
    body: jsonEncode({
      "userId": '2',
      "title": 'Introduction to API',
      "body": 'You have learnt some of these concepts now is the time to apply them.'
  })
    );
    if (response.statusCode == 200) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
